      ...
      <div className="container-custom">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <SectionTitle
            ...
            subtitle="2000+ довольных клиентов за 11 лет. Вот что они говорят."
          />
          <Link href="/reviews" className="btn-outline flex-shrink-0" style={{ alignSelf: "flex-start" }}>
            Все отзывы
        ...
        >
          ...
          <div className="w-px h-16 hidden md:block" style={{ background: "rgba(255,255,255,0.08)" }} />
          <div className="text-center md:text-left">
            <div className="text-3xl font-bold text-white">2000+</div>
            <div className="text-sm mt-1" style={{ color: "#737373" }}>Довольных клиентов</div>
          </div>
          <div className="w-px h-16 hidden md:block" style={{ background: "rgba(255,255,255,0.08)" }} />
          <div className="flex-1 text-center md:text-left">
            <p className="text-sm" style={{ color: "#a3a3a3" }}>
              Наши клиенты — это посольства, корпорации, свадебные агентства, организаторы мероприятий и частные VIP-клиенты.
              Мы гордимся репутацией, которую строили 11 лет.
            </p>
          </div>
        </div>
      </div>
