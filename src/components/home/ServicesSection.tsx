      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-end mb-12">
          <div>
            ...
            >
              Всё для идеальной поездки
            </h2>
          </div>
          <div>
            <p style={{ color: "#737373", lineHeight: "1.7" }}>
              От трансфера из аэропорта до организации транспорта для делегаций — закрываем все потребности в VIP-перевозках по Алматы.
            </p>
          </div>
        </div>

        {/* Featured services — 2-column grid (not 4-equal) */}
          ...
          {featured.map((service, i) => (
            ...
            >
              <Link
                ...
                className="card-dark p-6 group hover-lift block h-full"
