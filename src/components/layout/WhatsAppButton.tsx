...
export function WhatsAppButton() {
  ...
  const message = encodeURIComponent(
    "Здравствуйте! Хочу узнать подробнее об аренде автомобиля с водителем."
  );
  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="flex items-center justify-center rounded-full shadow-2xl transition-transform duration-200 hover:scale-110 active:scale-95"
        style={{
          width: "58px",
          height: "58px",
          background: "linear-gradient(135deg, #25D366 0%, #128C7E 100%)",
          boxShadow: pulse
            ? "0 0 0 0 rgba(37, 211, 102, 0.4), 0 8px 32px rgba(37,211,102,0.35)"
            : "0 8px 32px rgba(37,211,102,0.25)",
          animation: pulse ? "pulse-gold 2s ease-in-out infinite" : "none",
        }}
      >
